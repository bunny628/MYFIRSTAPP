...
export class UpdateUserComponent implements OnInit {
  ...
  constructor(private activeModal: NgbActiveModal, private userService: UserService, private toastService: toastsService) { }
   ...
   if(this.user){
     let edit: Users ={
      ...
      profilePicture: this.profilePicture
       ...
       const result = this.userService.updateUser(edit);
    ...
    let add: Users ={
      ...
      profilePicture: this.profilePicture
       ...
       const result = this.userService.addUser(add);
       this.activeModal.close();
